...
import com.study.another.config.FeignDisableHystrixConfiguration;
...
//@FeignClient(name = "user-provider",path = "/user-provider",configuration = FeignDisableHystrixConfiguration.class)
